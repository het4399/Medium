...
export default function HeroSection({ blogSliderRef }: HeroSectionProps) {
    ...
    const words = ["Your Narrative", "Your Opinion", "Your Stage"];
    ...
    return (
        <div className="relative flex flex-col items-center justify-center min-h-screen bg-[#696773] text-white overflow-hidden px-4">
