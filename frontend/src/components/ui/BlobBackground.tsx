                ...
                {isHovered && (
                    <motion.div
                        ...
                        style={{
                            position: "absolute",
                            inset: -10,
                            background: `radial-gradient(circle, ${gradientColors?.[0] || color || "#fff"
                                }33 0%, transparent 70%)`,
                            borderRadius: "50%",
                        }}
                    />
...
const defaultBlobs: BlobConfig[] = [
...
]; const customBlobs = [
    {
        ...
        size: 380,                // reduced slightly
        blur: 50,                 // lower blur = better GPU perf
        speed: 10,                // slightly smoother
        opacity: 0.28,            // visually similar
        zIndex: 1,
        initialPosition: { x: 30, y: 30 },
        pulseScale: 1.15,         // slightly toned down
        rotationSpeed: 6,         // more fluid, less taxing
